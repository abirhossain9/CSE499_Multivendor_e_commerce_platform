                ...
                <div class="main-body">
                    <div class="row gutters-sm">
                        <div class="col-md-12 mb-3">
                            <h4 class="text-danger">Payment Unsuccessfull for <b class="text-primary">{{$order->product->product_name}}</b>. Please Try Again!</h4>
                        </div>
                        {{-- profile info --}}
                        ...
                        {{-- order info --}}
                        <div class="col-md-12">
                            <a class="btn btn-primary" href="{{route('user.dashboard')}}" role="button">Return to Dashboard</a>
                        </div>
                    </div>
                </div>
            </div>
