...
@section('body')
      ...
      <div class="br-pagetitle">
        ...
        <div>
          <h4>Dashboard</h4>
          <p class="mg-b-0">Dashboard for this website. See various information from here</p>
        </div>
      </div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="bg-info rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                ...
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Total Branches</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{$branches->count()}}</p>
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
            <div class="bg-purple rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                ...
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Total Employees</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{$employees->count()}}</p>
                </div>
              </div>
